 ...
 * [availableWidth] after subtracting [horizontalPadding], clamped to between [minCount] and
 * [maxCount]. Shared by [IconPicker] and [ColorPicker] so both rows grow on wider containers
