# habit-history-layout-stability Specification

## Purpose
Define the layout-stability guarantees for the habit history dot row, so it does not jump or change truncation when a completion toggle updates the streak label in constrained, full-capacity layouts.
## Requirements
