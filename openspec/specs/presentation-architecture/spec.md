...
## Purpose
Define and preserve presentation-architecture guardrails introduced in the #753 refactor: immutable UiState collections, null-safe event handling, targeted exception behavior, and decomposition of large presentation files into focused units while keeping screen/ViewModel entry APIs stable.
## Requirements
