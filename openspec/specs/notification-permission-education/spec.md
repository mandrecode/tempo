# notification-permission-education Specification

## Purpose
Define the contextual education shown before the Android notification permission prompt, so users understand reminder notifications in product terms each time they attempt to create a reminder while notification permission is missing.
## Requirements
