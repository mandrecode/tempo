...
## Purpose
Define startup-performance guarantees that keep the cold-start path lean by deferring non-UI maintenance work that is not required to draw the first frame.
## Requirements
