...
- **Persistent supporting pane at width ≥ 1200dp (PR 2).** The task/habit editor renders as a docked, non-modal pane beside the content via a supporting-pane scene: list stays interactive, no scrim, editor survives rotation/resize in the back stack. The Phase 2 placement rule grows to three-way: bottom sheet / modal side sheet / docked pane.
