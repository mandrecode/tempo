...
- **M3 breakpoint retune (PR 2).** The labeled rail moves to ≥1200dp, 600–1199dp uses the collapsed rail, Settings remains a selected Nav3 destination wherever a rail is visible, and Sort uses a bottom sheet only at compact widths with an anchored menu at medium and larger widths.
