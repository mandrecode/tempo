...
- Preserve quick-task submission while also dismissing the keyboard after its Done action.
...
- Affects Compose presentation code for task, habit, habit-chain, quick-task, and category inputs in `:app`.
