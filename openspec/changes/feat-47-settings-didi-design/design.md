...
- No app-wide color-system rollout for issue #50.
...
3. Use Material theme tokens and surface containers for light/dark card treatment.
...
4. Preserve existing external-intent behavior in the content layer for this change.
